...
```console
shell$ wget https://github.com/ikwzm/ZynqMP-FPGA-Debian12/archive/refs/tags/v4.0.0.tar.gz
shell$ tar xfz v4.0.0.tar.gz
shell$ cd ZynqMP-FPGA-Debian12-4.0.0
```
 ...
 * files/
     - vmlinuz-6.1.70-zynqmp-fpga-generic-1                     : Linux Kernel Image
 * debian12-rootfs-vanilla.tgz.files/                           : Debian12 Root File System
   + x00 .. x09                                                 : (splited files)
 * debian/
   - linux-image-6.1.70-zynqmp-fpga-generic_6.1.70-zynqmp-fpga-generic-1_arm64.deb   : Linux Image Package
   - linux-headers-6.1.70-zynqmp-fpga-generic_6.1.70-zynqmp-fpga-generic-1_arm64.deb : Linux Headers Package
...
shell# gzip -d -c files/vmlinuz-6.1.70-zynqmp-fpga-generic-1 > /mnt/usb1/image-6.1.70-zynqmp-fpga-generic
```
