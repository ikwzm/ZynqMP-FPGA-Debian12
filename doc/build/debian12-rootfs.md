...
[./doc/build/linux-kernel-6.1.38-zynqmp-fpga-generic.md](linux-kernel-6.1.38-zynqmp-fpga-generic.md)
...
shell$ sudo cp debian/linux-image-6.1.38-zynqmp-fpga-generic_6.1.38-zynqmp-fpga-generic-2_arm64.deb $PWD/$targetdir
```
...
debian12-rootfs# cat <<EOT > /etc/network/interfaces.d/end0
allow-hotplug end0
...
debian12-rootfs# dpkg -i linux-image-6.1.38-zynqmp-fpga-generic_6.1.38-zynqmp-fpga-generic-2_arm64.deb
```
...
shell$ sudo rm -f $PWD/$targetdir/linux-image-6.1.38-zynqmp-fpga-generic_6.1.38-zynqmp-fpga-generic-2_arm64.deb
